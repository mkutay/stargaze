...
constexpr const std::array<int, 64> mg_pawn_table = {
      0,   0,   0,   0,   0,   0,  0,   0,
...
constexpr const std::array<int, 64> eg_pawn_table = {
      0,   0,   0,   0,   0,   0,   0,   0,
...
constexpr const std::array<int, 64> mg_knight_table = {
...
constexpr const std::array<int, 64> eg_knight_table = {
...
constexpr const std::array<int, 64> mg_bishop_table = {
...
constexpr const std::array<int, 64> eg_bishop_table = {
...
constexpr const std::array<int, 64> mg_rook_table = {
...
constexpr const std::array<int, 64> eg_rook_table = {
...
constexpr const std::array<int, 64> mg_queen_table = {
...
constexpr const std::array<int, 64> eg_queen_table = {
...
constexpr const std::array<int, 64> mg_king_table = {
...
constexpr const std::array<int, 64> eg_king_table = {
...
// Indexed by Piece.
constexpr const std::array<int, 6> mg_value = {82, 337, 365, 477, 1025, 0};
constexpr const std::array<int, 6> eg_value = {94, 281, 297, 512, 936, 0};

constexpr const std::array<std::array<int, 64>, 6> mg_pesto_table = {
    {mg_pawn_table, mg_knight_table, mg_bishop_table, mg_rook_table,
     mg_queen_table, mg_king_table}};

constexpr const std::array<std::array<int, 64>, 6> eg_pesto_table = {
    {eg_pawn_table, eg_knight_table, eg_bishop_table, eg_rook_table,
     eg_queen_table, eg_king_table}};

/**
 * mg_table[colour][piece][square]
 *
 * Board uses a1=0 (LERF); PeSTO tables use a8=0 convention.
 * White pieces sit at low indices (rank 1-2) so flip sq^56 to convert to
 ...
 * gamephase_inc[piece]
 *
 * It is identical for both colours.
 *
 * Counts: 8 pawns, 2 knights, 2 bishops, 2 rooks, 1 queen, 1 king (per side).
 */
constexpr int calculate_gamephase_sum(const std::array<int, 6> &inc) {
